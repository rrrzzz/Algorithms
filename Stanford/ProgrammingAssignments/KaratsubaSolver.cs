...
namespace Algorithms.Stanford.ProgrammingAssignments
{
    public class KaratsubaSolver
    {
        ...
        const string FirstNumber = "3141592653589793238462643383279502884197169399375105820974944592";
        const string SecondNumber = "3141592653589793238462643383279502884197169399375105820974944592";
